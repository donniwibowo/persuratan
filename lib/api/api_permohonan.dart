...
class ApiPermohonan extends ChangeNotifier {
  ...
  Future<List<PermohonanModel>> getAllPermohonan(String keyword) async {
    ...
    final api_url = 'https://tigajayabahankue.com/dms-persuratan/public/api/form/getallpermohonan/' +
        user_token +
        '/' +
        keyword;
  ...
  Future<List<PermohonanModel>> getDetailPermohonan(
    ...
    final api_url = 'https://tigajayabahankue.com/dms-persuratan/public/api/form/getpermohonan/' +
        user_token +
        '/' +
        permohonan_id +
        '/' +
  ...
  Future<List<PermohonanModel>> getUnreadPermohonan() async {
    ...
    final api_url =
        'https://tigajayabahankue.com/dms-persuratan/public/api/form/getunreadpermohonan/' + user_token;
    final response = await http.get(Uri.parse(api_url));
